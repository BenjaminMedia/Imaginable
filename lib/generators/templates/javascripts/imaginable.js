(function($){
  ...
  var Imaginable = function(element, options) {
    ...
    var existing_image = main_elem.data('imaginable-has-image');
    var image_version;
    ...
    this.croppedImageURI = function(uuid, width, height, format) {
       ...
       var crop_string = "crop=" + Math.round(crop_points.x1) + "px," + Math.round(crop_points.y1) + "px," + Math.round(crop_points.x2) + "px," + Math.round(crop_points.y2) + "px";
